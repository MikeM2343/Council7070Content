...
<Image src="/api/images/Web/4th_degree-clr.png" float="right" width="200" />
...
<Card
  image="/api/images/Web/4th_degree-clr.png"
  link="/OtherPages/FourthDegreeEmblem"
  picPos="bottom"
  title="The Origin of the Fourth Degree Emblem"
  width="200"
