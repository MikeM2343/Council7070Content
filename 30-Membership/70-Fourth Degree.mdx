...
---
<Image  src="/img/4th_degree-clr.png"  float="right"  width="200" />
...
<Card  image="/img/4th_degree-clr.png"  link="/OtherPages/FourthDegreeEmblem"  picPos="top"  title="The Origin of the Fourth Degree Emblem"  width="fit-content"  maxWidth="fit-content" />
