...
summary: An Easter retreat for keeping the Triduum alive
summaryImage: /api/pictures/picture/Web/StainedGlass.jpg
...
<Image
  float="right"
  m="20px"
  src="/api/pictures/picture/Web/StainedGlass.jpg"
  width="50%"
/>
